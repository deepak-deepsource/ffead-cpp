...
extern void *ffead_cpp_handle_rust_swift_1(
    const struct ffead_request *request, int *scode, const char **out_url,
    size_t *out_url_len, const char **out_mime, size_t *out_mime_len,
    struct phr_header_fcp *out_headers, size_t *out_headers_len,
