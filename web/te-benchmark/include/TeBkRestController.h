...
#pragma @GET path = "/queries" statusCode = "200" ocontentType =               \
    "application/json"
  std::vector<TeBkWorld> queries(
#pragma @QueryParam name = "queries"
      std::string queries);

#pragma @GET path = "/updates" statusCode = "200" ocontentType =               \
    "application/json"
...
#pragma @GET path = "/cached-worlds" statusCode = "200" ocontentType =         \
    "application/json"
  std::vector<TeBkWorld> cachedWorlds(
#pragma @QueryParam name = "count"
      std::string count);

#pragma @GET path = "/plaintext-um" statusCode = "200" ocontentType =          \
    "text/plain" unmapped = "true"
