...
bool MarkerSecurityProvider::authenticate(const std::string &username,
                                          const std::string &password) {
  std::cout << "Username is " << username << ", Password is " << password
            << std::endl;
  return true;
}
...
bool MarkerSecurityProvider::isInitialized() { return true; }
