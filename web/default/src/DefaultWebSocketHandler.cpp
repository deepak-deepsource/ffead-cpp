...
bool DefaultWebSocketHandler::onOpen(WebSocketData *req,
...
bool DefaultWebSocketHandler::isWriteControl() { return false; }

bool DefaultWebSocketHandler::onMessage(WebSocketData *req,
                                        WebSocketRespponseData *res,
