...
public:
  void setStrProp(std::string *strProp) { this->strProp = strProp; }
  std::string *getStrProp() { return this->strProp; }

  void setDependencyBean1(DependencyBean1 *dependencyBean1) {
    this->dependencyBean1 = dependencyBean1;
  }
  DependencyBean1 *getDependencyBean1() { return this->dependencyBean1; }

  void setDependencyBean2(DependencyBean2 *dependencyBean2) {
    this->dependencyBean2 = dependencyBean2;
  }
  DependencyBean2 *getDependencyBean2() { return this->dependencyBean2; }

  void setDependencyBean3(DependencyBean3 *dependencyBean3) {
    this->dependencyBean3 = dependencyBean3;
  }
  DependencyBean3 *getDependencyBean3() { return this->dependencyBean3; }
