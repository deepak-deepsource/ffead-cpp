...
ffead_response *get_resp(int scode, phr_header_fcp *out_headers) {
  ...
  if (scode == 1) {
    ...
    resp->scode = 0;
    resp->done = 0;
    resp->out_url = "/Users/sumeetc/Projects/GitHub/ffead-cpp/web/default/"
                    "public/index.html";
...
void *ffead_cpp_handle_go(const char *server_str, size_t server_str_len,
                          ...
                          const char *path, size_t path_len, const char *query,
                          size_t query_len, int version, const char *in_headers,
                          size_t in_headers_len, const char *in_body,
                          size_t in_body_len, int *scode, const char **out_url,
                          size_t *out_url_len, const char **out_mime,
                          size_t *out_mime_len, phr_header_fcp *out_headers,
...
void *ffead_cpp_handle_1j(int *scode, const char **out_url, size_t *out_url_len,
                          const char **out_mime, size_t *out_mime_len,
                          const char **out_body, size_t *out_body_len,
                          const char **out_headers, size_t *out_headers_len,
                          const char *server_str, size_t server_str_len,
                          const char *method, size_t method_len,
                          const char *path, size_t path_len, const char *body,
                          size_t body_len, int version, int headers_len, ...) {
  printf("dummy ffead_cpp_handle_1j\n");
  printf("%d\n", headers_len);
  printf("%d\n", headers_len / 4);
  printf("dummy ffead_cpp_handle_1 %d %d %d %d %d %d \n", *scode,
         server_str_len, method_len, path_len, version, headers_len);
  printStr("Server = ", server_str, server_str_len);
  printStr("Method = ", method, method_len);
  printStr("Path = ", path, path_len);
  printf("Version = %d\n", version);
...
void *ffead_cpp_handle_1s(const ffead_request *request, int *scode,
...
void *ffead_cpp_handle_crystal_1(const ffead_request3 *request, int *scode,
                                 const char **smsg, size_t *smsg_len,
                                 const char **out_mime, size_t *out_mime_len,
                                 const char **out_url, size_t *out_url_len,
                                 phr_header_fcp *out_headers,
...
void *ffead_cpp_handle_1c(const ffead_request3 *request, int *scode,
                          const char **smsg, size_t *smsg_len,
                          const char **out_mime, size_t *out_mime_len,
                          const char **out_url, size_t *out_url_len,
                          phr_header_fcp *out_headers, size_t *out_headers_len,
