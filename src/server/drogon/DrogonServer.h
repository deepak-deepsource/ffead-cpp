...
class DrogonWebsockHandler
    : public drogon::WebSocketController<DrogonWebsockHandler> {
public:
...
public:
  ...
  METHOD_LIST_BEGIN
  ADD_METHOD_VIA_REGEX(DrogonHttpHandler::handle, ".*", Get, Post, Put, Delete,
                       Head, Options);
  METHOD_LIST_END
};
...
public:
  static void runServer(std::string ip_addr, std::string port,
