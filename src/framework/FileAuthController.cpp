...
FileAuthController::FileAuthController(const std::string &filename,
...
bool FileAuthController::authenticate(const std::string &username,
...
bool FileAuthController::getPassword(const std::string &username,
                                     std::string &passwd) {
  bool passwdf = false;
  std::ifstream ifs(this->filename.c_str());
...
std::string FileAuthController::get(const std::string &username,
                                    const int &pos) {
  // bool passwdf = false;
  std::ifstream ifs(this->filename.c_str());
  if (ifs.is_open() && username != "") {
