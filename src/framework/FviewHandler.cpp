...
bool FviewHandler::handle(HttpRequest *req, HttpResponse *res) {
  ...
  if (infile.is_open()) {
    ...
    if (h != (int)std::string::npos) {
      ...
      content =
          st + "<script type=\"text/javascript\" src=\"json2.js\"></script>";
      content +=
          "<script type=\"text/javascript\" src=\"prototype.js\"></script>";
      content += "<script type=\"text/javascript\" src=\"afc.js\"></script>";
      content +=
          "<script type=\"text/javascript\" src=\"_afc_Objects.js\"></script>";
      content += "<script type=\"text/javascript\" "
                 "src=\"_afc_Interfaces.js\"></script>";
      content += "<script type=\"text/javascript\" src=\"" + fviewmap[file] +
                 ".js\"></script>" + en;
    } else {
