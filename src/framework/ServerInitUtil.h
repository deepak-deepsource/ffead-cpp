...
public:
  ...
  static void initIB();
  static void initIB(cb_reg_ext_fd_pv pvregfd, cb_into_pv cb,
...
public:
  ...
  virtual ~PicoVWriter() {}
  int internalWrite(const char *hline, size_t hline_len, const char *body,
                    size_t body_len) {
    return cb(hline, hline_len, body, body_len, fd, pv);
  }
  int writeData(void *data) { return 1; };
  void *getData() { return &adata; }
};
