...
// Copied from
// https://github.com/OSEHRA-Sandbox/gtm-bindings/blob/master/Source/GTM.h
#ifndef __GTM_h
#define __GTM_h
...
public:
  ...
  //
  //  Methods using std::string for arguments and Exceptions for error
  //  management.
  //
  ...
  //
  //  Methods using unsigned int for arguments and Exceptions for error
  //  management.
  //
  ...
  //
  //  Methods using unsigned long for arguments and Exceptions for error
  //  management.
  //
