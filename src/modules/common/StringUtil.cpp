...
void StringUtil::replaceFirst(std::string &str, const std::string &ths,
...
std::string StringUtil::replaceFirstCopy(const std::string &str,
                                         const std::string &ths,
                                         const std::string &with) {
  std::string strn = str;
...
void StringUtil::replaceAll(std::string &str, const std::string &ths,
                            const std::string &with) {
  if (ths.empty())
    return;
  size_t start_pos = 0;
  while ((start_pos = str.find(ths, start_pos)) != std::string::npos) {
    str.replace(start_pos, ths.length(), with);
    start_pos += with.length(); // In case 'to' contains 'from', like replacing
                                // 'x' with 'yx'
  }
}

std::string StringUtil::replaceAllCopy(const std::string &str,
                                       const std::string &ths,
                                       const std::string &with) {
  std::string strn = str;
...
void StringUtil::camelCased(std::string &str, const std::string &delim) {
  std::vector<std::string> vec =
      StringUtil::splitAndReturn<std::vector<std::string>>(str, delim);
  str.clear();
...
std::string StringUtil::camelCasedCopy(const std::string &str,
...
void StringUtil::replaceLast(std::string &str, const std::string &ths,
                             const std::string &with) {
...
std::string StringUtil::replaceLastCopy(const std::string &str,
                                        const std::string &ths,
                                        const std::string &with) {
  std::string strn = str;
...
int StringUtil::countOccurrences(const std::string &input,
...
StringUtil::split(const std::string &input,
...
void StringUtil::split(std::vector<std::string> &output,
...
bool StringUtil::endsWith(const std::string_view &str,
