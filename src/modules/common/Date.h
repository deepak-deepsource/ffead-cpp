...
class Date {
  ...
  long getMinutesI(const long y, const long m, const long d, const long hh,
                   const long mi) const;
  unsigned long long getSecondsI(const long y, const long m, const long d,
                                 const long hh, const long mi,
                                 const long ss) const;
  static Date getDateFromDaysInternal(const long &days);
  void compare(const Date &d, unsigned long long &thisss,
