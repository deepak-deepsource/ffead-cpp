...
bool ConnectionPooler::isInitialized() const { return initialized; }
...
ConnectionProperties &ConnectionPooler::getProps() { return properties; }

const ConnectionProperties &ConnectionPooler::getProperties() const {
  return properties;
}

void *ConnectionPooler::getEnv() { return _env; }

void ConnectionPooler::setEnv(void *env) { _env = env; }
