...
bool Element::operator==(const Element &ele) const {
  if (this->tagName == ele.tagName && this->attributes == ele.attributes)
    return true;
  else
    return false;
}
...
void Element::addAttribute(const std::string &k, const std::string &value,
                           const bool &validate) {
  if (StringUtil::trimCopy(value) == "")
    return;
...
const AttributeList &Element::getAttributes() const { return this->attributes; }
...
const ElementList &Element::getChildElements() const { return elements; }
const std::string &Element::getTagName() const { return this->tagName; }
const std::string &Element::getNameSpc() { return this->nameSpace; }
...
const std::string &Element::getText() const { return this->text; }

void Element::setText(const std::string &text) { this->text = text; }

bool Element::getCdata() const { return this->cdata; }

void Element::setCdata(const bool &cdata) { this->cdata = cdata; }
...
std::string Element::getNameSpcValue() { return getNmspc(this, nameSpace); }
