...
public:
  ...
  static std::string camelCasedCopy(const std::string &str,
                                    const std::string &delim);
  static void toUpper(std::string &str);
  static std::string toUpperCopy(const std::string &str);
  static void toLower(std::string &str);
  static std::string toLowerCopy(const std::string &str);
  static void replaceFirst(std::string &str, const std::string &ths,
                           const std::string &with);
  static std::string replaceFirstCopy(const std::string &str,
                                      const std::string &ths,
                                      const std::string &with);
  static void replaceLast(std::string &str, const std::string &ths,
                          const std::string &with);
  static std::string replaceLastCopy(const std::string &str,
                                     const std::string &ths,
                                     const std::string &with);
  static void replaceAll(std::string &str, const std::string &ths,
                         const std::string &with);
  static std::string replaceAllCopy(const std::string &str,
                                    const std::string &ths,
                                    const std::string &with);
  static std::vector<std::string>
  split(const std::string &input, const std::vector<std::string> &delimiters);
  static void split(std::vector<std::string> &output, const std::string &input,
                    const std::vector<std::string> &delimiters);
  template <class ContainerT>
  static void split(ContainerT &tokens, const std::string &str,
  ...
  template <class ContainerT>
  static ContainerT splitAndReturn(const std::string &str,
                                   const std::string &delimiters,
                                   const bool &trimEmpty = false) {
    typedef ContainerT Base;
    typedef typename Base::value_type Vt;
  ...
  static int countOccurrences(const std::string &input,
