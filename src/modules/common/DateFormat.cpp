...
DateFormat::DateFormat() { this->formatspec = DF; }

DateFormat::~DateFormat() {}

DateFormat::DateFormat(const std::string &format) { this->formatspec = format; }
...
const std::string &DateFormat::getFormatspec() const { return formatspec; }
