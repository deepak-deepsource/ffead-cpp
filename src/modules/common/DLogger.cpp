...
void DLogger::info(std::string msg) { m_pInstance->write(msg, "info"); }

void DLogger::debug(std::string msg) { m_pInstance->write(msg, "debug"); }

void DLogger::error(std::string msg) { m_pInstance->write(msg, "error"); }
