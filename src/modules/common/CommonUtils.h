...
typedef void (*GetClassBeanIns)(std::string &clsn, std::string appn,
                                ClassBeanIns *cbi);
...
public:
  ...
  charArrayToULongLong(const std::vector<unsigned char> &l);
  static std::string xorEncryptDecrypt(const std::string &toEncrypt,
  ...
  static void
  printMap(const std::map<int, std::map<std::string, std::string>> &mp);
  ...
  static std::vector<std::string> getFiles(const std::string &cwd,
                                           const std::string &suffix,
                                           const bool &isAbs = true);
  static void listFiles(std::vector<std::string> &files, const std::string &cwd,
                        const std::string &suffix, const bool &isAbs = true);
  ...
  static std::string getTpeFnName(const std::string &tpe,
                                  const std::string &appName, bool fast = true);
  // Copied from
