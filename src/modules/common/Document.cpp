...
Element &Document::getRootElement() { return this->root; }

void Document::setRootElement(const Element &root) { this->root = root; }

const std::string &Document::getDocType() const { return docType; }
