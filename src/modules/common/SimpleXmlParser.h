...
/*
    ...
    writer.startElement("Goldeneye").attribute("date", "1998").content("This is
   a James Bond movie").closeElement();
    writer.startElement("Leon").attribute("director", "Luc Besson");
    writer.startElement("Actor").attribute("role", "Leon").attr("name", "Jean
   Reno").cdata("<asdas></asdas>").closeAll(); std::cout << s << std::endl;
*/
...
public:
  ...
  static void readDocument(const std::string &filename,
