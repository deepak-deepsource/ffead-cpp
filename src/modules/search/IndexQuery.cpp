...
IndexQuery::IndexQuery() { status = -1; }

const std::string &IndexQuery::getError() const { return error; }
...
const std::string &IndexQuery::getName() const { return name; }
...
std::map<std::string, std::string> &IndexQuery::getExtras() { return extras; }
...
int IndexQuery::getStatus() const { return status; }
...
const std::string &IndexQuery::getOpType() const { return opType; }

void IndexQuery::setOpType(const std::string &opType) { this->opType = opType; }
