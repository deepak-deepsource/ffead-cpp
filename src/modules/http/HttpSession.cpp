...
#include <iostream>
HttpSession::HttpSession() { this->dirty = false; }

HttpSession::~HttpSession() {}
std::string HttpSession::getSessionId() const { return sessionId; }

void HttpSession::setSessionId(const std::string &sessionId) {
  this->sessionId = sessionId;
}

Map HttpSession::getSessionAttributes() { return sessionAttributes; }
...
void HttpSession::setAttribute(const std::string &key,
