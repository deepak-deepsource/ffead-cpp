...
bool Http2PriorityFrame::isExclusive() const { return exclusive; }

int Http2PriorityFrame::getStreamDependency() const { return streamDependency; }

Http2PriorityFrame::Http2PriorityFrame(std::string data,
...
unsigned char Http2PriorityFrame::getWeight() const { return weight; }
