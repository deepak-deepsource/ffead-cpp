...
public:
  ...
  virtual bool writePendingDataFrame(Http2RequestResponseData &,
                                     std::string &data) = 0;
  // virtual bool writeData(Http2RequestResponseData& data,
  // Http2RequestResponseData& pendingSendData, int&
  // streamFlowControlWindowS)=0;
  virtual void writeInitData(Http2Frame *data) = 0;
  virtual std::vector<std::string>
  getRelatedEntitiesForPP(const std::string &) = 0;
