...
public:
  CorsConfig();
  CorsConfig(const std::string &allwdOrigins, const std::string &allwdMethods,
             const std::string &allwdHeaders, const std::string &exposedHeaders,
...
public:
  ...
  virtual ~CORSHandler();
  static bool handle(CorsConfig &corsConfig, HttpRequest *req,
                     HttpResponse *res);
};
