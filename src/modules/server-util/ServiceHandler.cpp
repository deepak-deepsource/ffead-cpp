...
bool ServiceHandler::isActive() { return run; }
...
void ServiceHandler::registerServiceRequest(void *request, SocketInterface *sif,
...
HandlerRequest::~HandlerRequest() { clearObjects(); }
...
void *HandlerRequest::getContext() { return context; }

int HandlerRequest::getProtType() const { return sif->getType(context); }

void *HandlerRequest::getRequest() { return request; }

void *HandlerRequest::getResponse() { return response; }
...
SocketInterface *HandlerRequest::getSif() { return sif; }
