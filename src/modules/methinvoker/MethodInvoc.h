...
public:
  MethodInvokerException(std::string message, std::string &ret) {
    message = "<return:exception>" + message + "</return:exception>";
    ret = message;
  }
...
/*
<method className="ExampleClass" methodName="exampleMethod" returntype="string"
retByValOrRef="value" startTranx="true"> <arguments> <arg
type="string">asdfsdf</arg> <arg type="SomeClass"><SomeClass><id
type=""><></SomeClass></arg> <arg type="string">asdfsdf</arg>
    </arguments>
</method>
*/
