...
class CacheMap {
  ...
  CacheMap();
  static bool checkExistance(const std::string &cacheKey,
...
public:
  static std::string MAP_ENTRY, COLL_ENTRY, SIZE, CLEAR, IS_EMPTY, ALLOCATE,
      DEALLOCATE, MAP, SET, LIST, VECTOR, QUEUE, DEQUE, ADD, GET, GET_FRONT,
      GET_BACK, POP, POP_BACK, POP_FRONT, PUSH_FRONT, PUSH_BACK, INSERT,
      OBJ_ENTRY, REMOVE, GETBYPOS, POPGET, POP_FRONTGET, POP_BACKGET;
  static std::string SUCCESS, ERR_NOELEMENTS, ERR_NOKEYCACHEMAP,
      ERR_INVCONTAINER, ERR_OPNOTSUPP, ERR_INDGRTCONTSIZ, ERR_NOVALUEFOUND,
      ERR_NOTAMAPCONT, ERR_ALLOCENTEXISTS, ERR_NOVALUESPEC, ERR_NEGATIVEPOS,
  ...
  static void addMapEntry(const std::string &, const std::string &,
                          const std::string &);
  ...
  static std::string getMapEntryValueByPosition(const std::string &,
                                                const int &);
  static void setMapEntryValueByPosition(const std::string &, const int &,
                                         const std::string &);
  ...
  static void setCollectionEntryAt(const std::string &, const int &,
                                   const std::string &);
