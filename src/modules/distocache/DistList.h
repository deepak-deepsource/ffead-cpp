...
public:
  ...
  void pop_back() { cl->popBackValue(cacheKey); }
  void pop_front() { cl->popFrontValue(cacheKey); }
  std::string get_pop_back() { return cl->popGetBackValue(cacheKey); }
  std::string get_pop_front() { return cl->popGetFrontValue(cacheKey); }
