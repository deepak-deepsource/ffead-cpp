...
class DistoCacheClientUtils {
  ...
  std::string readValueOrThrowExp(AMEFObject *object,
                                  const std::vector<std::string> &ignoreErrors);

public:
  DistoCacheClientUtils(const std::string &host, const int &port,
  ...
  void addMapEntry(const std::string &, const std::string &,
                   const std::string &);
  ...
  void setMapEntryValueByPosition(const std::string &, const int &,
                                  const std::string &);
  ...
  void setCollectionEntryAt(const std::string &, const int &,
                            const std::string &);
