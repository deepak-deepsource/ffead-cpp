...
Message::Message(const std::string &xml) {
  ...
  if (message.getTagName() != "message") {
    ...
    throw InvalidMessageException(
        "Every message should have a headers and body tag\n");
  }
  ...
  if (destination->getTagName() != "destination") {
    ...
    throw InvalidMessageException(
        "Type and Name Attributes should be speciifes for a Destination\n");
  } else if (destination->getAttribute("name") == "" ||
             destination->getAttribute("type") == "") {
    throw InvalidMessageException(
        "Type and Name Attributes cannot be blank for a Destination\n");
...
Destination Message::getDestination() const { return this->destination; }

void Message::setDestination(const Destination &destination) {
  this->destination = destination;
}

std::string Message::getTimestamp() const { return this->timestamp; }

void Message::setTimestamp(const std::string &timestamp) {
  this->timestamp = timestamp;
}

std::string Message::getType() const { return this->type; }

void Message::setType(const std::string &type) { this->type = type; }

std::string Message::getPriority() const { return this->priority; }

void Message::setPriority(const std::string &priority) {
  this->priority = priority;
}

std::string Message::getUserId() const { return this->userId; }

void Message::setUserId(const std::string &userId) { this->userId = userId; }

std::string Message::getBody() const { return this->body; }

void Message::setBody(const std::string &body) { this->body = body; }

std::string Message::getEncoding() const { return this->encoding; }
