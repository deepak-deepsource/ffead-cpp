...
class Reflection {
  ...
  void
  handleNamespace(std::string data, std::string namepsc,
  ...
  void collectInfo(std::string data, const std::string &flag,
                   ClassStructure &cls, const std::vector<std::string> &mrktxt);
  void emptyBlocks(std::string &data, size_t);

public:
  std::map<std::string, ClassStructure, std::less<>>
  getClassStructures(const std::string &className, const std::string &);
  ...
  static std::string getNameSpaceId(const std::string &nmsp,
  ...
  /*string getWsTreatedClassName()
  {
          ...
          {
                  return "ns" + CastUtil::fromNumber(nmspcIds[nmSpc]) + ":" +
  classN;
          }
          return classN;
  }*/
  std::string
  getFullyQualifiedClassName(const std::string &classN,
  ...
  std::string
  getTreatedFullyQualifiedClassName(const std::string &classN,
                                    const std::vector<std::string> &namespaces,
                                    const bool &stripns = true) {
    for (int var = 0; var < (int)namespaces.size(); ++var) {
      std::string tempfqnmclz = namespaces.at(var) + classN;
      if (classNamespaces.find(tempfqnmclz) != classNamespaces.end()) {
        if (stripns) {
  ...
  strVec getAfcObjectData(ClassStructure &classStructure, const bool &object,
                          std::vector<std::string> &privf, bool &isOpForSet);
  // strVec getAfcObjectData(const std::string&, const bool&);
  propMap getDbTableInfo(const std::string &);
  std::string generateClassDefinitionsAll(
  ...
  std::string generateSerDefinitionAll(
      std::map<std::string, std::map<std::string, ClassStructure, std::less<>>,
               std::less<>> &clsstrucMaps,
  ...
  std::string generateClassDefinition_Old(
      std::map<std::string, ClassStructure, std::less<>> &allclsmap,
      std::string &includesDefs, std::string &typedefs, std::string &classes,
      std::string &methods, std::string &opers, const std::string &app);
  std::string generateSerDefinition(
      std::map<std::string, ClassStructure, std::less<>> &allclsmap,
      std::string &includesDefs, std::string &typedefs, std::string &classes,
  ...
  std::string generateClassDefinitions(
      ...
      std::string &includesDefs, std::string &typedefs, std::string &classes,
      std::string &methods, std::string &opers, const std::string &app);
  std::string generateSerDefinitions(
      std::map<std::string, ClassStructure, std::less<>> &allclsmap,
      std::string &includesDefs, std::string &typedefs, std::string &classes,
      std::string &methods, const bool &isBinary, std::string &objs,
      std::string &ajaxret, std::string &headers, std::string &typerefs,
      const std::string &app);
  std::string generateSerDefinitionBinary(
      std::map<std::string, ClassStructure, std::less<>> &allclsmap,
      std::string &includesDefs, std::string &typedefs, std::string &classes,
      std::string &methods, const std::string &app);
  std::string generateAllSerDefinition(
      std::map<std::string, ClassStructure, std::less<>> &allclsmap,
      std::string &includesDefs, std::string &typedefs, std::string &classes,
      std::string &methods, const std::string &app);
