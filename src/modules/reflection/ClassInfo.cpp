...
std::string ClassInfo::getClassName() const { return className; }

void ClassInfo::setClassName(const std::string &className) {
  this->className = className;
}

std::string ClassInfo::getBase() const { return base; }

void ClassInfo::setBase(const std::string &base) { this->base = base; }
...
ctorMap ClassInfo::getConstructors() { return this->ctors; }

const Method &ClassInfo::getMethod(const std::string &methodName,
                                   args argumentTypes) const {
...
fldMap ClassInfo::getFields() { return fields; }

fldVec ClassInfo::getFieldVec() { return fldvec; }

methMap ClassInfo::getMethods() { return meths; }

void ClassInfo::setNamespace(const std::string &namespc) {
  this->namespc = namespc;
}

std::string ClassInfo::getNamespace() { return namespc; }

void ClassInfo::setSize(const int &size) { this->size = size; }

int ClassInfo::getSize() { return this->size; }

const std::string &ClassInfo::getDestRefName() const { return destRefName; }
...
void ClassInfo::addOperatorRefName(const std::string &oper,
                                   const std::string &rn) {
  if (operRefNames.find(oper) == operRefNames.end()) {
...
std::string ClassInfo::getContRefName() { return contRefName; }

void *ClassInfo::getSI() { return si; }

NewInst ClassInfo::getIns() { return f; }
...
void ClassInfo::setContRefName(const std::string &rn) { contRefName = rn; }
