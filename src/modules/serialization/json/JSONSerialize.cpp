...
std::string JSONSerialize::serializePrimitive(int serOpt,
...
void JSONSerialize::startContainerSerialization(void *_1,
                                                const std::string &className,
...
void JSONSerialize::endContainerSerialization(void *_1,
                                              const std::string &className,
                                              const std::string &container) {
#ifdef HAVE_RAPID_JSON
  RapiJsonState *object = (RapiJsonState *)_1;
...
void JSONSerialize::afterAddContainerSerializableElement(void *_1,
                                                         const int &counter,
                                                         const int &size) {
...
void JSONSerialize::addContainerSerializableElement(void *_1,
                                                    const std::string &tem) {}

void JSONSerialize::addContainerSerializableElementMulti(
    void *_1, const std::string &tem) {}
...
std::string JSONSerialize::elementToSerializedString(void *_1,
                                                     const int &counter) {
#ifdef HAVE_RAPID_JSON
...
std::string
JSONSerialize::getConatinerElementClassName(void *_1,
                                            const std::string &className) {
...
void *JSONSerialize::getContainerElement(void *_1, const int &counter,
                                         const int &counter1) {
#ifdef HAVE_RAPID_JSON
  rapidjson::Value *nroot = (rapidjson::Value *)_1;
  if (!nroot->IsArray() || nroot->Size() < counter)
...
void JSONSerialize::addPrimitiveElementToContainer(
    void *_1, int serOpt, const int &counter, const std::string &className,
    void *cont, const std::string &container) {
#ifdef HAVE_RAPID_JSON
  rapidjson::Value *nroot = (rapidjson::Value *)_1;
  switch (serOpt) {
  case 1: {
    std::string oval((*nroot)[counter].GetString(),
                     (*nroot)[counter].GetStringLength());
    if (container == "std::set" || container == "std::multiset")
      addValueToNestedContainerSV(container, oval, cont);
    else
      addValueToNestedContainer(container, oval, cont);
    break;
  }
  case 2: {
    char retVal;
    ...
    if (container == "std::set" || container == "std::multiset")
      addValueToNestedContainerSV(container, retVal, cont);
    else
  ...
  case 4: {
    ...
    try {
      ...
      try {
        retVal =
            CastUtil::toInt(std::string((*nroot)[counter].GetString(),
                                        (*nroot)[counter].GetStringLength()));
      } catch (...) {
      }
    }
  ...
  case 5: {
    ...
    try {
      ...
      try {
        retVal =
            CastUtil::toUInt(std::string((*nroot)[counter].GetString(),
                                         (*nroot)[counter].GetStringLength()));
      } catch (...) {
      }
    }
  ...
  case 6: {
    ...
    try {
      ...
      try {
        retVal =
            CastUtil::toShort(std::string((*nroot)[counter].GetString(),
                                          (*nroot)[counter].GetStringLength()));
      } catch (...) {
      }
    }
  ...
  case 7: {
    ...
    try {
      ...
      try {
        retVal = CastUtil::toUShort(
            std::string((*nroot)[counter].GetString(),
                        (*nroot)[counter].GetStringLength()));
      } catch (...) {
      }
    }
  ...
  case 8: {
    ...
    try {
      ...
      try {
        retVal =
            CastUtil::toLong(std::string((*nroot)[counter].GetString(),
                                         (*nroot)[counter].GetStringLength()));
      } catch (...) {
      }
    }
  ...
  case 9: {
    ...
    try {
      ...
      try {
        retVal =
            CastUtil::toULong(std::string((*nroot)[counter].GetString(),
                                          (*nroot)[counter].GetStringLength()));
      } catch (...) {
      }
    }
  ...
  case 15: {
    ...
    try {
      ...
      try {
        retVal =
            CastUtil::toBool(std::string((*nroot)[counter].GetString(),
                                         (*nroot)[counter].GetStringLength()));
      } catch (...) {
      }
    }
  ...
  case 16: {
    DateFormat formt;
    Date *_d = formt.parse(std::string((*nroot)[counter].GetString(),
                                       (*nroot)[counter].GetStringLength()));
    if (container == "std::set" || container == "std::multiset")
      addValueToNestedContainerSV(container, *_d, cont);
    else
      addValueToNestedContainer(container, *_d, cont);
    delete _d;
    break;
  }
  }
...
std::string
JSONSerialize::getUnserializableClassName(void *_1,
                                          const std::string &className) {
  return className;
}

void *JSONSerialize::getPrimitiveValue(void *_1, int serOpt,
                                       const std::string &className) {
...
std::string JSONSerialize::serializeUnknown(void *t, int serOpt,
                                            const std::string &className,
                                            Ser f1, SerCont f2, SerCont f3,
                                            void *serobject,
...
#endif
    _handleAllSerialization(serOpt, className, t, appName, &_i, f1, f2, f3,
                            serobject);
#ifdef HAVE_RAPID_JSON
...
std::string JSONSerialize::serializeUnknown(void *t, int serOpt,
  ...
  if (soe) {
    ...
    serobject = new RapiJsonState(serobject);
#endif
    _handleAllSerialization(serOpt, className, t, appName, &_i, NULL, NULL,
                            NULL, serobject);
#ifdef HAVE_RAPID_JSON
    _i.cleanSerializableObject(serobject);
#endif
...
void *JSONSerialize::unSerializeUnknown(const std::string &objJson, int serOpt,
                                        const std::string &className,
                                        const std::string &appName) {
  return _handleAllUnSerialization(objJson, serOpt, className, appName, &_i,
                                   true, NULL);
}

bool JSONSerialize::isValidClassNamespace(void *_1,
                                          const std::string &classname,
...
bool JSONSerialize::isValidObjectProperty(void *_1, const std::string &propname,
                                          const int &counter) {
#ifdef HAVE_RAPID_JSON
  rapidjson::Value *nroot = (rapidjson::Value *)_1;
  if (nroot->IsObject()) {
    return nroot->HasMember(
        rapidjson::StringRef(propname.c_str(), propname.length()));
  }
  return false;
#else
  JSONElement *node = (JSONElement *)_1;
...
void JSONSerialize::startObjectSerialization(void *_1,
                                             const std::string &className) {
#ifdef HAVE_RAPID_JSON
  RapiJsonState *object = (RapiJsonState *)_1;
...
void JSONSerialize::endObjectSerialization(void *_1,
                                           const std::string &className) {
#ifdef HAVE_RAPID_JSON
  RapiJsonState *object = (RapiJsonState *)_1;
...
void JSONSerialize::addObjectPrimitiveProperty(void *_1, int serOpt,
                                               const std::string &propName,
                                               const std::string &className,
                                               void *t) {
#ifdef HAVE_RAPID_JSON
...
#else
    *object +=
        "\"" + propName + "\":" + CastUtil::fromNumber(*(unsigned int *)t);
#endif
    break;
  }
  case 6: {
...
#else
    *object +=
        "\"" + propName + "\":" + CastUtil::fromNumber(*(unsigned short *)t);
#endif
    break;
  }
  case 8: {
...
#else
    *object +=
        "\"" + propName + "\":" + CastUtil::fromNumber(*(unsigned long *)t);
#endif
    break;
  }
  case 10: {
...
#else
    *object += "\"" + propName +
               "\":" + CastUtil::fromNumber(*(unsigned long long *)t);
#endif
    break;
  }
  case 12: {
...
#else
    *object +=
        "\"" + propName + "\":" + CastUtil::fromLongdouble(*(long double *)t);
#endif
    break;
  }
  case 15: {
...
#else
    *object += "\"" + propName + "\":\"" +
               BinaryData::serilaize(*(BinaryData *)t) + "\"";
#endif
  }
  }
}

void JSONSerialize::addObjectProperty(void *_1, const std::string &propName,
...
void *JSONSerialize::getObjectPrimitiveValue(void *_1, int serOpt,
                                             const std::string &className,
                                             const std::string &propName) {
#ifdef HAVE_RAPID_JSON
  rapidjson::Value *nroot = (rapidjson::Value *)_1;
  ...
  case 4: {
    ...
    try {
      *vt = nroot->GetInt();
      ...
      try {
        *vt = CastUtil::toInt(
            std::string(nroot->GetString(), nroot->GetStringLength()));
      } catch (...) {
      }
    }
    return vt;
...
std::string JSONSerialize::serializeUnknownBaseInt(void *t, int serOpt,
                                                   const std::string &className,
                                                   const std::string &appName,
                                                   void *serobject) {
  return _handleAllSerialization(serOpt, className, t, appName, this, NULL,
                                 NULL, NULL, serobject);
}

std::string JSONSerialize::serializeUnknownBase(void *t, int serOpt,
                                                const std::string &className,
                                                const std::string &appName,
                                                void *serobject) {
  bool soe = serobject != NULL;
  if (soe) {
    ...
    serobject = new RapiJsonState(serobject);
#endif
    _handleAllSerialization(serOpt, className, t, appName, this, NULL, NULL,
                            NULL, serobject);
#ifdef HAVE_RAPID_JSON
...
void *JSONSerialize::unSerializeUnknownBase(void *unserObj, int serOpt,
                                            const std::string &className,
                                            const std::string &appName) {
  return _handleAllUnSerialization(CommonUtils::BLANK, serOpt, className,
                                   appName, this, true, unserObj);
}
void *JSONSerialize::unSerializeUnknownBase(const std::string &serVal,
                                            int serOpt,
                                            const std::string &className,
                                            const std::string &appName) {
  return _handleAllUnSerialization(serVal, serOpt, className, appName, this,
                                   true, NULL);
}

std::string Serializer::toJson(const std::string &appName,
  ...
  if (soe) {
    ...
    serobject = new RapiJsonState(serobject);
#endif
    SerializeBase::_ser(object, className, appName, &JSONSerialize::_i,
                        serobject);
#ifdef HAVE_RAPID_JSON
  ...
  return SerializeBase::_ser(object, className, appName, &JSONSerialize::_i,
                             serobject);
}
...
std::string Serializer::toJson(const std::string &appName,
  ...
  if (soe) {
    ...
    serobject = new RapiJsonState(serobject);
#endif
    SerializeBase::_serContainer(object, className, appName, container,
                                 &JSONSerialize::_i, serobject);
#ifdef HAVE_RAPID_JSON
    JSONSerialize::_i.cleanSerializableObject(serobject);
#endif
    return CommonUtils::BLANK;
  }
  return SerializeBase::_serContainer(object, className, appName, container,
                                      &JSONSerialize::_i, serobject);
}

void *Serializer::fromJson(const std::string &appName, std::string className,
                           void *serObject) {
  return SerializeBase::_unser(serObject, className, appName,
                               &JSONSerialize::_i);
}

void *Serializer::fromJson(const std::string &appName, std::string className,
                           const std::string &container, void *serObject) {
  return SerializeBase::_unserContainer(serObject, className, appName,
                                        container, &JSONSerialize::_i);
}
...
std::string JSONSerialize::serializeObjectCont(void *t, SerCont f,
                                               const std::string &container,
                                               void *serobject) {
  bool soe = serobject != NULL;
  if (f != NULL && soe) {
