...
std::string BinarySerialize::serializePrimitive(int serOpt,
  ...
  switch (serOpt) {
  case 1:
    object.addPacket(*(std::string *)t, className);
    break;
  case 2:
    object.addPacket((char *)t, className);
    break;
  case 3:
    object.addPacket((unsigned char *)t, className);
    break;
  case 4:
    object.addPacket(*(int *)t, className);
    break;
  case 5:
    object.addPacket(*(unsigned int *)t, className);
    break;
  case 6:
    object.addPacket(*(short *)t, className);
    break;
  case 7:
    object.addPacket(*(unsigned short *)t, className);
    break;
  case 8:
    object.addPacket(*(long *)t, className);
    break;
  case 9:
    object.addPacket(*(unsigned long *)t, className);
    break;
  case 10:
    object.addPacket(*(long long *)t, className);
    break;
  case 11:
    object.addPacket(*(unsigned long long *)t, className);
    break;
  case 12:
    object.addPacket(*(float *)t, className);
    break;
  case 13:
    object.addPacket(*(double *)t, className);
    break;
  case 14:
    object.addPacket(*(long double *)t, className);
    break;
  case 15:
    object.addPacket(*(bool *)t, className);
    break;
  case 16: {
    DateFormat formt;
...
void BinarySerialize::startContainerSerialization(
    void *_1, const std::string &className, const std::string &container) {
  AMEFEncoder enc;
  AMEFObject *object = (AMEFObject *)_1;
  object->setName(container + "-" + className);
}

void BinarySerialize::endContainerSerialization(void *_1,
                                                const std::string &className,
                                                const std::string &container) {}

void BinarySerialize::afterAddContainerSerializableElement(void *_1,
                                                           const int &counter,
                                                           const int &size) {}

void BinarySerialize::addContainerSerializableElement(void *_1,
...
void BinarySerialize::addContainerSerializableElementMulti(
...
std::string BinarySerialize::elementToSerializedString(void *_1,
                                                       const int &counter) {
  AMEFObject *object = (AMEFObject *)_1;
...
std::string
BinarySerialize::getConatinerElementClassName(void *_1,
                                              const std::string &className) {
...
void *BinarySerialize::getContainerElement(void *_1, const int &counter,
                                           const int &counter1) {
  AMEFDecoder dec;
  AMEFObject *root = static_cast<AMEFObject *>(_1);
  AMEFObject *root2 =
      dec.decodeB(root->getPackets().at(counter)->getValue(), true);
  return root2;
}

void BinarySerialize::addPrimitiveElementToContainer(
...
std::string
BinarySerialize::getUnserializableClassName(void *_1,
                                            const std::string &className) {
  AMEFObject *root = static_cast<AMEFObject *>(_1);
  return root->getNameStr();
}

void *BinarySerialize::getPrimitiveValue(void *_1, int serOpt,
                                         const std::string &className) {
  AMEFObject *root = static_cast<AMEFObject *>(_1);
...
std::string BinarySerialize::serializeUnknown(void *t, int serOpt,
                                              const std::string &className,
                                              void *serobject,
...
void *BinarySerialize::unSerializeUnknown(const std::string &objXml, int serOpt,
                                          const std::string &className,
                                          const std::string &appName) {
...
bool BinarySerialize::isValidClassNamespace(void *_1, const std::string &cn,
  ...
  if (element->getNameStr() != className ||
      (iscontainer && element->getPackets().size() == 0))
    return false;
  return true;
}

bool BinarySerialize::isValidObjectProperty(void *_1,
...
void BinarySerialize::startObjectSerialization(void *_1,
                                               const std::string &className) {
  AMEFEncoder enc;
  AMEFObject *object = (AMEFObject *)_1;
...
void BinarySerialize::endObjectSerialization(void *_1,
                                             const std::string &className) {}
...
void BinarySerialize::addObjectPrimitiveProperty(void *_1, int serOpt,
                                                 const std::string &propName,
                                                 const std::string &className,
                                                 void *t) {
  AMEFObject *object = (AMEFObject *)_1;
...
void BinarySerialize::addObjectProperty(void *_1, const std::string &propName,
                                        std::string className) {}

void *BinarySerialize::getObjectPrimitiveValue(void *_1, int serOpt,
                                               const std::string &className,
                                               const std::string &propName) {
  AMEFObject *root = static_cast<AMEFObject *>(_1);
  root = root->getPackets().at(0);
...
std::string BinarySerialize::serializeUnknownBase(void *t, int serOpt,
                                                  const std::string &className,
                                                  const std::string &appName,
                                                  void *serobject) {
...
void *BinarySerialize::unSerializeUnknownBase(void *unserObj, int serOpt,
                                              const std::string &className,
                                              const std::string &appName) {
  return _handleAllUnSerialization("", serOpt, className, appName, this, false,
                                   unserObj);
}
void *BinarySerialize::unSerializeUnknownBase(const std::string &serVal,
                                              int serOpt,
                                              const std::string &className,
                                              const std::string &appName) {
