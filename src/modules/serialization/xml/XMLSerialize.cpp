...
std::string XMLSerialize::serializePrimitive(int serOpt,
  ...
  case 5: {
    ...
    return "<element>" + CastUtil::fromNumber(*(unsigned int *)t) +
           "</element>";
  }
  case 6: {
    if (str != NULL) {
  ...
  case 7: {
    ...
    return "<element>" + CastUtil::fromNumber(*(unsigned short *)t) +
           "</element>";
  }
  case 8: {
    if (str != NULL) {
  ...
  case 9: {
    ...
    return "<element>" + CastUtil::fromNumber(*(unsigned long *)t) +
           "</element>";
  }
  case 10: {
    if (str != NULL) {
  ...
  case 11: {
    ...
    return "<element>" + CastUtil::fromNumber(*(unsigned long long *)t) +
           "</element>";
  }
  case 12: {
    if (str != NULL) {
  ...
  case 14: {
    ...
    return "<element>" + CastUtil::fromLongdouble(*(long double *)t) +
           "</element>";
  }
  case 15: {
    if (str != NULL) {
...
void XMLSerialize::startContainerSerialization(void *_1,
                                               const std::string &className,
...
void XMLSerialize::endContainerSerialization(void *_1,
                                             const std::string &className,
                                             const std::string &container) {
  XmlWriter *xw = (XmlWriter *)_1;
  xw->closeElement();
...
void XMLSerialize::afterAddContainerSerializableElement(void *_1,
                                                        const int &counter,
                                                        const int &size) {}

void XMLSerialize::addContainerSerializableElement(void *_1,
                                                   const std::string &tem) {}

void XMLSerialize::addContainerSerializableElementMulti(
...
std::string XMLSerialize::elementToSerializedString(void *_1,
                                                    const int &counter) {
#ifdef HAVE_PUGI_XML
...
std::string
XMLSerialize::getConatinerElementClassName(void *_1,
                                           const std::string &className) {
#ifdef HAVE_PUGI_XML
  pugi::xml_node doc((pugi::xml_node_struct *)_1);
...
void *XMLSerialize::getContainerElement(void *_1, const int &counter,
                                        const int &counter1) {
#ifdef HAVE_PUGI_XML
  pugi::xml_node doc((pugi::xml_node_struct *)_1);
  int cnt = 0, cnt1 = 0;
...
void XMLSerialize::addPrimitiveElementToContainer(
...
void *XMLSerialize::getValidUnserializableObject(const std::string &_1) {
  return NULL;
}
...
std::string
XMLSerialize::getUnserializableClassName(void *_1,
                                         const std::string &className) {
#ifdef HAVE_PUGI_XML
  pugi::xml_node doc((pugi::xml_node_struct *)_1);
...
void *XMLSerialize::getPrimitiveValue(void *_1, int serOpt,
                                      const std::string &className) {
#ifdef HAVE_PUGI_XML
  pugi::xml_node doc((pugi::xml_node_struct *)_1);
...
std::string XMLSerialize::serializeUnknown(void *t, int serOpt,
                                           const std::string &className,
                                           void *serobject,
...
void *XMLSerialize::unSerializeUnknown(const std::string &objXml, int serOpt,
                                       const std::string &className,
                                       const std::string &appName) {
  return _handleAllUnSerialization(objXml, serOpt, className, appName, &_i,
                                   false, NULL);
}

bool XMLSerialize::isValidClassNamespace(void *_1, const std::string &className,
                                         const std::string &namespc,
                                         const bool &iscontainer) {
  std::string cn = namespc + className;
#ifdef HAVE_PUGI_XML
  pugi::xml_node doc((pugi::xml_node_struct *)_1);
  if (!iscontainer && strcmp(doc.name(), "element") == 0 &&
      strcmp(doc.attribute("type").value(), cn.c_str()) == 0) {
    return true;
  }
  if (iscontainer && strcmp(doc.name(), "collection") == 0 &&
      strcmp(doc.attribute("etype").value(), cn.c_str()) == 0) {
    return true;
  }
#else
  Element *element = (Element *)_1;
  if (!iscontainer && element->getTagName() == "element" &&
      element->getAttribute("type") == cn) {
    return true;
  }
  if (iscontainer && element->getTagName() == "collection" &&
      element->getAttribute("etype") == cn) {
    return true;
  }
#endif
  return false;
...
bool XMLSerialize::isValidObjectProperty(void *_1, const std::string &propname,
                                         const int &counter) {
#ifdef HAVE_PUGI_XML
  pugi::xml_node doc((pugi::xml_node_struct *)_1);
  for (pugi::xml_node n : doc.children()) {
    if (strcmp(n.name(), "property") == 0 &&
        strcmp(n.attribute("name").value(), propname.c_str()) == 0) {
      return true;
    }
  }
#else
...
void *XMLSerialize::getObjectProperty(void *_1, const int &counter,
  ...
  for (pugi::xml_node n : doc.children()) {
    if (strcmp(n.name(), "property") == 0 &&
        strcmp(n.attribute("name").value(), propname.c_str()) == 0) {
      if (n.first_child().type() == pugi::xml_node_type::node_element)
        return n.first_child().internal_object();
...
void XMLSerialize::startObjectSerialization(void *_1,
                                            const std::string &className) {
  XmlWriter *xw = (XmlWriter *)_1;
...
void XMLSerialize::endObjectSerialization(void *_1,
                                          const std::string &className) {
  XmlWriter *xw = (XmlWriter *)_1;
  xw->closeElement();
}
...
void XMLSerialize::addObjectPrimitiveProperty(void *_1, int serOpt,
                                              const std::string &propName,
                                              const std::string &className,
                                              void *t) {
  XmlWriter *xw = (XmlWriter *)_1;
...
void XMLSerialize::addObjectProperty(void *_1, const std::string &propName,
...
void *XMLSerialize::getObjectPrimitiveValue(void *_1, int serOpt,
                                            const std::string &className,
                                            const std::string &propName) {
#ifdef HAVE_PUGI_XML
  pugi::xml_node doc((pugi::xml_node_struct *)_1);
  if (strcmp(doc.name(), "property") != 0 ||
      strcmp(doc.attribute("name").value(), propName.c_str()) != 0)
    return NULL;
  std::string tval(doc.text().get());
#else
  Element *root = (Element *)_1;
...
std::string XMLSerialize::serializeUnknownBaseInt(void *t, int serOpt,
                                                  const std::string &className,
                                                  const std::string &appName,
                                                  void *serobject) {
...
std::string XMLSerialize::serializeUnknownBase(void *t, int serOpt,
                                               const std::string &className,
                                               const std::string &appName,
                                               void *serobject) {
  bool soe = serobject != NULL;
...
void *XMLSerialize::unSerializeUnknownBase(void *unserObj, int serOpt,
                                           const std::string &className,
                                           const std::string &appName) {
  return _handleAllUnSerialization("", serOpt, className, appName, this, false,
                                   unserObj);
}
void *XMLSerialize::unSerializeUnknownBase(const std::string &serVal,
                                           int serOpt,
                                           const std::string &className,
                                           const std::string &appName) {
...
std::string Serializer::toXml(const std::string &appName, std::string className,
                              void *object, void *serobject) {
  bool soe = serobject != NULL;
  if (soe) {
    serobject = new SimpleStringXmlWriter((std::string *)serobject);
    SerializeBase::_ser(object, className, appName, &XMLSerialize::_i,
                        serobject);
    XMLSerialize::_i.cleanSerializableObject(serobject);
    return CommonUtils::BLANK;
  }
  return SerializeBase::_ser(object, className, appName, &XMLSerialize::_i,
                             serobject);
}
...
void *Serializer::fromXml(const std::string &appName, std::string className,
                          void *serObject) {
